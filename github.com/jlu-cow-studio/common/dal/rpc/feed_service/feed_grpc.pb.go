...
func (c *feedServiceClient) GetFeed(ctx context.Context, in *GetFeedRequest, opts ...grpc.CallOption) (*GetFeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jlu_cow_studio.feed.FeedService/GetFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedServiceClient) ResetFeed(ctx context.Context, in *ResetFeedRequest, opts ...grpc.CallOption) (*ResetFeedResponse, error) {
	out := new(ResetFeedResponse)
	err := c.cc.Invoke(ctx, "/jlu_cow_studio.feed.FeedService/ResetFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFeedServiceServer) ResetFeed(context.Context, *ResetFeedRequest) (*ResetFeedResponse, error) {
...
func _FeedService_GetFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jlu_cow_studio.feed.FeedService/GetFeed",
	}
...
func _FeedService_ResetFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeedServiceServer).ResetFeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jlu_cow_studio.feed.FeedService/ResetFeed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).ResetFeed(ctx, req.(*ResetFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "jlu_cow_studio.feed.FeedService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FeedService_ResetFeed_Handler,
		},
	},
